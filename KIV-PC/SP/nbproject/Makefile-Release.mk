...
${OBJECTDIR}/src/built-in.o: src/built-in.c 
	...
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/built-in.o src/built-in.c

${OBJECTDIR}/src/built-in_list.o: src/built-in_list.c 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/built-in_list.o src/built-in_list.c

${OBJECTDIR}/src/built-in_math.o: src/built-in_math.c 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/built-in_math.o src/built-in_math.c

${OBJECTDIR}/src/built-in_system.o: src/built-in_system.c 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/built-in_system.o src/built-in_system.c

${OBJECTDIR}/src/commons.o: src/commons.c 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/commons.o src/commons.c

${OBJECTDIR}/src/console.o: src/console.c 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/console.o src/console.c
...
${OBJECTDIR}/src/interpreter.o: src/interpreter.c 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/interpreter.o src/interpreter.c

${OBJECTDIR}/src/lexer.o: src/lexer.c 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/lexer.o src/lexer.c
...
${OBJECTDIR}/src/reader.o: src/reader.c 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/reader.o src/reader.c

${OBJECTDIR}/src/repl.o: src/repl.c 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/repl.o src/repl.c

${OBJECTDIR}/src/types.o: src/types.c 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/types.o src/types.c
...
${TESTDIR}/tests/built-in-test.o: tests/built-in-test.c 
	...
	${RM} "$@.d"
	$(COMPILE.c) -O2 -I. -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/built-in-test.o tests/built-in-test.c


${TESTDIR}/tests/eval-test.o: tests/eval-test.c 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.c) -O2 -I. -I. -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/eval-test.o tests/eval-test.c
...
${OBJECTDIR}/src/built-in_nomain.o: ${OBJECTDIR}/src/built-in.o src/built-in.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/built-in_nomain.o src/built-in.c;\
	else  \
...
${OBJECTDIR}/src/built-in_list_nomain.o: ${OBJECTDIR}/src/built-in_list.o src/built-in_list.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/built-in_list_nomain.o src/built-in_list.c;\
	else  \
...
${OBJECTDIR}/src/built-in_math_nomain.o: ${OBJECTDIR}/src/built-in_math.o src/built-in_math.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/built-in_math_nomain.o src/built-in_math.c;\
	else  \
...
${OBJECTDIR}/src/built-in_system_nomain.o: ${OBJECTDIR}/src/built-in_system.o src/built-in_system.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/built-in_system_nomain.o src/built-in_system.c;\
	else  \
...
${OBJECTDIR}/src/commons_nomain.o: ${OBJECTDIR}/src/commons.o src/commons.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/commons_nomain.o src/commons.c;\
	else  \
...
${OBJECTDIR}/src/console_nomain.o: ${OBJECTDIR}/src/console.o src/console.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/console_nomain.o src/console.c;\
	else  \
...
${OBJECTDIR}/src/heap_nomain.o: ${OBJECTDIR}/src/heap.o src/heap.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/heap_nomain.o src/heap.c;\
	else  \
...
${OBJECTDIR}/src/interpreter_nomain.o: ${OBJECTDIR}/src/interpreter.o src/interpreter.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/interpreter_nomain.o src/interpreter.c;\
	else  \
...
${OBJECTDIR}/src/lexer_nomain.o: ${OBJECTDIR}/src/lexer.o src/lexer.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/lexer_nomain.o src/lexer.c;\
	else  \
...
${OBJECTDIR}/src/reader_nomain.o: ${OBJECTDIR}/src/reader.o src/reader.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/reader_nomain.o src/reader.c;\
	else  \
...
${OBJECTDIR}/src/repl_nomain.o: ${OBJECTDIR}/src/repl.o src/repl.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/repl_nomain.o src/repl.c;\
	else  \
...
${OBJECTDIR}/src/types_nomain.o: ${OBJECTDIR}/src/types.o src/types.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/types_nomain.o src/types.c;\
	else  \
